...
include_once $_SERVER["DOCUMENT_ROOT"]."/_pro_inc/checkLoginAD.php";	
          ...
          <div class="main_container">
            <div class="user-account__inner">
              ...
              <div class="user-account_btns mt40">
                ...
                <button type="button" class="btn btn-sm btn-round btn_brand"
                  onclick="openModal('modal-register-user')">신규등록</button>
              </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk2">
                            <input type="checkbox" id="chk2" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk3">
                            <input type="checkbox" id="chk3" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk4">
                            <input type="checkbox" id="chk4" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk5">
                            <input type="checkbox" id="chk5" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk6">
                            <input type="checkbox" id="chk6" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk7">
                            <input type="checkbox" id="chk7" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk8">
                            <input type="checkbox" id="chk8" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk9">
                            <input type="checkbox" id="chk9" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="checkbox--typeA center">
                          <label for="chk10">
                            <input type="checkbox" id="chk10" name="chk_user" value="">
                            <em class="check"></em>
                          </label>
                        </div>
                      </td>
                  ...
                  <div class="form_input--typeA">
                    ...
                    <div class="input_content">
                      <div class="auth_box">
                        ...
                        <button type="button" class="btn btn-lg btn_outline_brand"
                          onclick="openModal('modal-register-position')">포지션 등록</button>
                      </div>
                    </div>
                  </div>
                  <div class="form_input--typeA">
